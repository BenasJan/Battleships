...
namespace Battleships.Migrations
{
    ...
    [Migration("20221104071239_AddShipState")]
    partial class AddShipState
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Battleships.Models.ShipTile", b =>
                {
                    b.HasOne("Battleships.Models.Player", "AttackerPlayer")
                        .WithMany()
                        .HasForeignKey("AttackerPlayerId");

                    b.HasOne("Battleships.Models.PlayerShip", "PlayerShip")
                        .WithMany("Tiles")
                        .HasForeignKey("PlayerShipId");

                    b.HasOne("Battleships.Models.Player", "TargetPlayer")
                        .WithMany()
